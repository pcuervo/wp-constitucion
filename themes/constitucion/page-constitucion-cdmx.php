...
<?php get_sidebar(); ?>
<section>
	<div class="[ bg-image rectangle-small ][ margin-bottom ][ relative ]" style="background-image: url('<?php echo THEMEPATH; ?>/images/edificios.png');">
...
<article class="[ bg-gray-light ][ margin-top-bottom--large padding--top-bottom--large ]">
	<section class="[ container ]">
		<h2 class="[ no-margin-top ]">Proceso participativo</h2>
...
<section class="[ bg-image rectangle ][ margin-bottom ][ relative ]" style="background-image: url('<?php echo THEMEPATH; ?>/images/edificios.png');"></section>
<section class="[ container ][ margin-bottom--large ]">
	<h2>Preguntas frecuentes</h2>
	<div class="[ row ]">
		<div class="[ col-xs-12 col-sm-6 ]">
			<p class="[ text-uppercase ]"><strong>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</strong></p>
