					...
					<div class="[ border-primary border--3 ]">
						<div class="[ padding ]">
							...
							<div class="[ col col-2 ]">
								...
								<p class="[ color-gray--strong ][ margin-top--small ]">A nombre de todas las personas que están involucradas en la redacción de la Constitución de la Ciudad de México, te otorgo el presente reconocimiento por haber contribuido con tus ideas, reflexiones y propuestas para este proyecto.</p>
								...
								<p class="[ color-gray--strong ][ margin-top--small ][ text-center ]">Miguel Ángel Mancera Espinosa</p>
								<p class="[ color-gray--strong ][ margin-top--xsmall ][ text-center ]">Jefe de Gobierno de la Ciudad de México</p>
