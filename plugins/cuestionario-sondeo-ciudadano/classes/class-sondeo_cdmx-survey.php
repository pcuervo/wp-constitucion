					...
					<form id="myform" class="fs-form fs-form-full" autocomplete="off">
						<ol class="fs-fields">
							...
							<li id="js-captcha" data-question="999">
								...
								<p class="[ accept-terms ][ color-primary ]">Al aceptar, estoy de acuerdo con las políticas de privacidad, términos y condiciones de la plataforma. <a href="#nada">Ver más.</a></p>
							</li>
						</ol><!-- /fs-fields -->
